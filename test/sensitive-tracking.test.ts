        ...
        if (table === 'cycle_settings') {
          if (state.operation === 'upsert') {
            settings = {
              ...
              reminder_days_before: 7, typical_cycle_length_days: null, created_at: '', updated_at: '', ...state.payload,
            } as CycleSettingsRow;
          }
